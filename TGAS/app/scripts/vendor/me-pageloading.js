angular.module("me-pageloading", []).value("mePageLoadingEffects", {
...
}).value("mePageLoadingTemplate", '<div id="pageloader" class="pageload-overlay"><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 80 60" preserveAspectRatio="none"><path /></svg></div>').factory("Animater", ["mePageLoadingEffects", function (a) {
    function b(a) {
        var b;
    ...
    this.autoPageLoading = !0, this.effect = "random", this.$get = ["mePageLoadingTemplate", "Animater", function (a, b) {
        function c(a) {
            h.show(a)
        }
        function d() {
...
}).run(["$rootScope", "mePageLoading", function (a, b) {
